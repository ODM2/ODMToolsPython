...
class pnlSource(wx.Panel):
    def __init__(self,prnt,id,pos,size,style,name):
        ...
        self.lstSource.InsertColumn(2, 'Contact Name')
        self.lstSource.InsertColumn(3, 'Phone')
        self.lstSource.InsertColumn(4, 'Email')
        self.lstSource.InsertColumn(5, 'Address')
        self.lstSource.InsertColumn(6, 'City')
        self.lstSource.InsertColumn(7, 'State')
        self.lstSource.InsertColumn(8, 'ZipCode')
        self.lstSource.InsertColumn(9, 'Citation')
        self.lstSource.InsertColumn(10, 'MetaDataID')
        self.lstSource.SetColumnWidth(0, 50)
        self.lstSource.SetColumnWidth(1, 100)
        self.lstSource.SetColumnWidth(10, 0)
